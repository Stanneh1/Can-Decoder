...
void AudiA1PQ25Interpreter::interpretComfort(twai_message_t &msg)    { if (msg.identifier == 0x351) sys_ctx->metrics.driver_door_open = (*(msg.data + 0) & 0x01); }
...
void AudiA1MQBA0Interpreter::interpretComfort(twai_message_t &msg)    { if (msg.identifier == 0x61C) sys_ctx->metrics.driver_door_open = (*(msg.data + 0) & 0x01); }
...
void VwPoloPQ25Interpreter::interpretComfort(twai_message_t &msg)    { if (msg.identifier == 0x351) sys_ctx->metrics.driver_door_open = (*(msg.data + 0) & 0x01); }
...
void VwPoloMQBA0Interpreter::interpretComfort(twai_message_t &msg)    { if (msg.identifier == 0x61C) sys_ctx->metrics.driver_door_open = (*(msg.data + 0) & 0x01); }
...
void SeatIbizaMQBA0Interpreter::interpretComfort(twai_message_t &msg)    { if (msg.identifier == 0x61C) sys_ctx->metrics.driver_door_open = (*(msg.data + 0) & 0x01); }
